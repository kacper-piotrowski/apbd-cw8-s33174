        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "ASUS", new DateOnly(1989, 4, 2), "ASUSTeK Computer Inc." }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 5, 8, 9, 0, 0, 0, DateTimeKind.Unspecified), "Gaming PC", 5, 36, 12.5f },
                    { 2, new DateTime(2026, 4, 15, 13, 30, 0, 0, DateTimeKind.Unspecified), "Office PC", 12, 24, 4.2f },
                    { 3, new DateTime(2026, 5, 10, 10, 0, 0, 0, DateTimeKind.Unspecified), "Home PC", 3, 24, 6.8f }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "AMD-R9", 2, 1, "AMD processor", "AMD Ryzen 9 7950X" },
                    { "ASU-4090", 3, 2, "Nvidia graphics card", "ASUS ROG Strix RTX 4090" },
                    { "INT-I9", 1, 1, "Intel processor", "Intel Core i9-14900K" }
                });
